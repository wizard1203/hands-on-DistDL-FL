...
def create_model(args, model_name, output_dim, **kargs):
    ...
    if model_name == "lr" and args.dataset == "mnist":
    ...
    elif model_name == "resnet18-cifar10" or model_name == "resnet18":
        model = ResNet18_cifar10(num_classes=output_dim)
        ...
        # model = ResNet50_cifar10(class_num=output_dim)
        model = models.resnet50(num_classes=output_dim, pretrained=False)
    elif model_name == "resnet50-cifar10" or model_name == "resnet50-cifar100" or model_name == "resnet50-smallkernel":
        model = ResNet50_cifar10(num_classes=output_dim)
    # TODO
